...
const AdminSignup = ({ onSignupSuccess, onSwitchToSignin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(API_ENDPOINTS.admin.signup, formData);
      setPopup({
        isVisible: true,
  ...
  const handleGoogleSignup = async (credentialResponse) => {
    ...
    try {
      ...
      setPopup({
        isVisible: true,
        message: 'Admin created successfully with Google!',
        type: 'success'
      });
      setTimeout(() => {
        onSignupSuccess();
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              minLength={6}
              className="form-input"
              placeholder="Enter your admin password (min 6 characters)"
            />
          </div>
